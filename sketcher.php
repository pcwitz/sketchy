<?php
    ...
    $sketcher = ucwords($_GET['sketcher']);
...
<?php
    ...
    include("inc_sketchy_connect.php");
        ...
        $sketcherid = $_GET['sketcherid'];



        

                echo "<h2>$sketcher Sketches</h2>";
        ...
        WHERE sketcherid=$sketcherid ORDER BY sketchid DESC";
        ...
        echo "<div id='container' class='js-masonry''data-masonry-options='{'itemSelector':'.item'}'>";
...

            {
                ...
                echo "<a class='deconstruct' href='sketcher.php?sketcherid=$sketcherid&sketcher=$sketcher&svg=$svg_path#decon'>deconstruct</a>";
